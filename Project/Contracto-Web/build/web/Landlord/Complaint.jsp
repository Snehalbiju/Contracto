    ...
    <html>
        ...
        <%
            if (request.getParameter("btn_submit") != null) {
                String insQry = "insert into tbl_complaint (complaint_title,complaint_description,complaint_date,landlord_id) "
                        + "values ('" + request.getParameter("txt_title") + "','" + request.getParameter("txt_description") + "',curdate()," + session.getAttribute("l_id") + ")";
                ...
                <table class="table table-striped" id="table1">
                    <thead>
                        ...
                        <tr>
                            ...
                            <td>Action</td>
                <%
                    String selQry = "select *from tbl_complaint c inner join tbl_landlord l on c.landlord_id=l.landlord_id where c.landlord_id='" + session.getAttribute("l_id") + "'";
