...
<jsp:useBean class="DB.ConnectionClass" id="con"></jsp:useBean>
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form id="form1" class="form" method="post" enctype="multipart/form-data" action="../Assets/ActionPages/LandlordProfileEditAction.jsp">
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <div class="avatar-upload">
                                    ...
                                    <div class="avatar-preview">
                                        <div id="imagePreview" style="background-image: url(../Assets/Files/LandlordPhoto/<%=rs.getString("landlord_photo")%>);">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="txt_name" value="<%=rs.getString("landlord_name")%>"/>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="txt_email" value="<%=rs.getString("landlord_email")%>"/>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                <textarea name="txt_address" class="form-control" cols="30"><%=rs.getString("landlord_address")%></textarea>
                            </div>
                        </div>
