...
<jsp:useBean class="DB.ConnectionClass" id="con"></jsp:useBean>
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Contractor Profile</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <%
        String selQry = "select *from tbl_contractor c inner join tbl_place p on p.place_id=c.place_id "
                + "inner join tbl_district d on d.district_id=p.district_id where contractor_id='" + request.getParameter("cID") + "'";
                ...
                <div class="card bg-indigo-indigo-700 h-100 shadow">
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center pt-5 text-center">
                            <img src="../Assets/Files/ContractorPhoto/<%=rs.getString("contractor_photo")%>" alt="Admin" class="rounded-circle" width="150">
                            <div class="mt-3">
                                <h4 class="text-white"><%=rs.getString("contractor_name")%></h4>
                                <p class="text-cyan-cyan-500 font-italic mb-1"><%=rs.getString("contractor_address")%></p>
                ...
                <div class="card h-100 shadow">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <%=rs.getString("contractor_gender")%>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <%=rs.getString("contractor_address")%>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <img src="../Assets/Files/ContractorProof/<%=rs.getString("contractor_proof")%>" class="w-25" alt="" id="myImg">
                            </div>
                        </div>
                    </div>
                </div>
