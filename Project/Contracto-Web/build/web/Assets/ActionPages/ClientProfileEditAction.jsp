...
//checking if request cotains multipart data
           ...
           //f_item=(FileItem)itr.next();
                        ...
                        if (field_name.equals("file_photo")) {
                            ...
                            String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\web\\Assets\\Files\\ClientPhoto\\";
                            Random r = new Random();
                            int r_num = r.nextInt(1111) + 999;

                            fn = "Client_" + r_num + ext;
    ...
    //Strinh str1="insert into tbl_wantedlist ()";
                ...
                String upQry = "update tbl_client set client_name='" + value[0] + "',client_email='" + value[1] + "',place_id='" + value[3] + "',client_gender='" + value[4] + "',client_address='" + value[5] + "',client_photo='" + fn + "' where client_id='" + session.getAttribute("cli_id") + "'";
        ...
        <script type="text/javascript">
            setTimeout(function() {
                window.location.href = '../../Client/EditProfile.jsp'
            }, 2000);
        </script>
        <%                }
                else{
