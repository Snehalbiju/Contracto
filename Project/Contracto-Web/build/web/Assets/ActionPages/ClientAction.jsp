...
//checking if request cotains multipart data
    ...
    //Strinh str1="insert into tbl_wantedlist ()";
            ...
            if (value[7].equals(value[8])) {
                String str1 = "insert into tbl_client(client_name,client_email,client_address,client_gender,client_contact,"
                        + "client_photo,place_id,client_password)"
                        + "values('" + value[0] + "','" + value[1] + "','" + value[6] + "','" + value[3] + "','" + value[2] + "','" + fn + "','" + value[5] + "','" + value[7] + "')";
