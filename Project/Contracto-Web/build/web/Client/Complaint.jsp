...
<jsp:useBean class="DB.ConnectionClass" id="con"></jsp:useBean> 
    ...
    <html>
        ...
        <%            if (request.getParameter("btn_submit") != null) {
                String insQry = "insert into tbl_complaint (complaint_title,complaint_description,complaint_date,client_id) "
                        + "values ('" + request.getParameter("txt_title") + "','" + request.getParameter("txt_description") + "',curdate()," + session.getAttribute("cli_id") + ")";
                ...
                <table class="table table-striped" id="table1">
                    <thead>
                        ...
                        <tr>
                            ...
                            <td>Action</td>
                            <%
                                String selQry = "select *from tbl_complaint c inner join tbl_client cl on c.client_id=cl.client_id where c.client_id='" + session.getAttribute("cli_id") + "'";
