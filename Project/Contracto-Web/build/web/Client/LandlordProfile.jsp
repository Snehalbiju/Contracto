...
<jsp:useBean class="DB.ConnectionClass" id="con"></jsp:useBean>
    ...
    <%
        String selQry = "select *from tbl_landlord l inner join tbl_place p on p.place_id=l.place_id "
                + "inner join tbl_district d on d.district_id=p.district_id where l.landlord_id='" + request.getParameter("lID") + "'";
