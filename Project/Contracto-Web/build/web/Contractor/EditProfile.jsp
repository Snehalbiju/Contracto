...
<jsp:useBean class="DB.ConnectionClass" id="con"></jsp:useBean>
    ...
    <%            
        String selQry = "select *from tbl_contractor c inner join tbl_place p on p.place_id=c.place_id "
                + "inner join tbl_district d on d.district_id=p.district_id where contractor_id='" + session.getAttribute("c_id") + "'";
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form id="form1" class="form" method="post" enctype="multipart/form-data" action="../Assets/ActionPages/ContractorProfileEditAction.jsp">
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <div class="avatar-upload">
                                    ...
                                    <div class="avatar-preview">
                                        <div id="imagePreview" style="background-image: url(../Assets/Files/ContractorPhoto/<%=rs.getString("contractor_photo")%>);">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="txt_name" value="<%=rs.getString("contractor_name")%>"/>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="txt_email" value="<%=rs.getString("contractor_email")%>"/>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                <textarea name="txt_address" class="form-control" cols="30"><%=rs.getString("contractor_address")%></textarea>
                            </div>
                        </div>
