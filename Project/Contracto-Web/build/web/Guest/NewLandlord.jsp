<%-- 
    Document   : NewLandlord
    Created on : 9 Jan, 2023, 10:21:50 AM
    Author     : HP
--%>
                                ...
                                <div class="col-md-6 col-12 mx-auto" >
                                    <div class="card bg-dark">
                                        <div class="card-header">
                                            <h2 class="card-title text-center">Landlord Registration</h2>
                                        </div>
                                        <div class="card-content">
                                            <div class="card-body">
                                                <form id="form1" class="form-box bg-dark needs-validation" novalidate method="post" enctype="multipart/form-data" action="../Assets/ActionPages/LandlordAction.jsp">
                                                    <div class="form-body">
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <label>Name</label>
