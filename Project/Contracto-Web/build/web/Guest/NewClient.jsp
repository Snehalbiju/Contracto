<%-- 
    Document   : NewClient
    Created on : 8 Jan, 2023, 6:11:45 AM
    Author     : HP
--%>
                                ...
                                <div class="col-md-6 col-12 mx-auto" >
                                    <div class="card bg-dark">
                                        <div class="card-header">
                                            <h2 class="card-title text-center">Client Registration</h2>
                                        </div>
                                        <div class="card-content">
                                            <div class="card-body">
                                                <form id="form1" class="form-box bg-dark needs-validation" novalidate method="post" enctype="multipart/form-data" action="../Assets/ActionPages/ClientAction.jsp">
                                                    <div class="form-body">
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <label>Name</label>
