...
//checking if request cotains multipart data
    ...
    //Strinh str1="insert into tbl_wantedlist ()";
                ...
                String upQry = "update tbl_contractor set contractor_name='" + value[0] + "',contractor_email='" + value[1] + "',place_id='" + value[3] + "',contractor_gender='" + value[4] + "',contractor_address='" + value[5] + "',contractor_photo='" + fn + "' where contractor_id='" + session.getAttribute("c_id") + "'";
        ...
        <script type="text/javascript">
            setTimeout(function() {
                window.location.href = '../../Contractor/EditProfile.jsp'
            }, 2000);
        </script>
        <%                }
                else{
