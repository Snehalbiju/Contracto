...
//checking if request cotains multipart data
           ...
           //f_item=(FileItem)itr.next();
                        ...
                        if (field_name.equals("file_photo")) {
                         ...
                         if (field_name.equals("file_proof")) {
                            ...
                            //setting path to store image
                            File proj_path = new File(config.getServletContext().getRealPath("/"));
                            String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\web\\Assets\\Files\\LandlordProof\\";
                            Random r = new Random();
                            int r_num = r.nextInt(1111) + 999;

                            proof = "Landlord_" + r_num + ext;
                            //creating a file object
    ...
    //Strinh str1="insert into tbl_wantedlist ()";
            ...
            if (value[7].equals(value[8])) {
                String str1 = "insert into tbl_landlord(landlord_name,landlord_email,landlord_contact,landlord_address,landlord_gender,"
                        + "landlord_photo,landlord_proof,landlord_password,place_id)"
                        + "values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + value[6] + "','" + value[3] + "','" + fn + "','" + proof + "','" + value[7] + "','" + value[5] + "')";
