    ...
    <html>
        ...
        <%
            if (request.getParameter("btn_submit") != null) {
                ...
                String selQry = "select contractor_password from tbl_contractor where contractor_id='" + session.getAttribute("c_id") + "'";
                ResultSet rs = con.selectCommand(selQry);
                if (rs.next()) {
                    if (cur_pwd.equals(rs.getString("contractor_password"))) {
        ...
        <%
                ...
                String upQry = "update tbl_contractor set contractor_password='" + request.getParameter("new_password") + "'"
                        + "where contractor_id='" + session.getAttribute("c_id") + "'";
