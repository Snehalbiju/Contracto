...
<jsp:useBean class="DB.ConnectionClass" id="con"></jsp:useBean>
    ...
    <html>
        ...
        <%            if (request.getParameter("btn_submit") != null) {
                ...
                String selQry = "select client_password from tbl_client where client_id='" + session.getAttribute("cli_id") + "'";
                ResultSet rs = con.selectCommand(selQry);
                if (rs.next()) {
                    if (cur_pwd.equals(rs.getString("client_password"))) {
        ...
        <%
            ...
            String upQry = "update tbl_client set client_password='" + request.getParameter("new_password") + "'"
                    + "where client_id='" + session.getAttribute("cli_id") + "'";
